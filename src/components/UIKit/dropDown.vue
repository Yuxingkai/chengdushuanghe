...
<style scoped>
  .choose{position: absolute; top: .225rem; right: .13rem; background: #0e1937; z-index: 6; cursor: pointer; }
  .choose h3 {background: #347ed587; border-radius: .02rem; min-width: 2.4rem; padding:.08rem .2rem .08rem .1rem; height: .5rem; line-height: .5rem; font-weight: normal; font-size: .3rem; color: #befefe; text-align: center; z-index: 5; }
