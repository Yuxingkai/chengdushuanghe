<template>
  <div
    class='test'
    ref='testDivDom'
    style=" position: absolute;left: 0;top: 0;border:1px dashed black;width: 100%;height: 100%;overflow: hidden">
    <!--:style="{backgroundImage: 'url(' + picUrl + ')',backgroundSize: 'center/100% 100%'}"-->
    <!--<img-->
    <!--src='../../../../assets/test.jpg'-->
    <!--alt=""-->
    <!--class='div_img'-->
    ...
    <div
      class='div_img'
      style="width: 1000px;top: 100px;height: 1000px;position: absolute;left: 100px;"
      :style="{backgroundImage: 'url(' + (picUrl !== ''&& picUrl !== null ? picUrl : dafaultPic) + ')',backgroundSize: 'cover',backgroundRepeat: 'no-repeat'}"
      @mousedown="dragImg"
      ref='dragImgDom'
      @mousewheel="fnWheel"
    />
...
export default {
  ...
  mounted () {
    ...
    this.dragImgDom.style.width = '700px'
    this.dragImgDom.style.height = '450px'
...
<style scoped>
  /*.div_img{*/
    /*!*background: url("../../../../assets/test.jpg") center/100% 100%;*!*/
  /*}*/
</style>
